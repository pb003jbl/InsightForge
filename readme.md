...
## AI Services
- **WatsonX API**: Primary LLM service using meta-llama/llama-3-3-70b-instruct model for strategic consulting insights
- **Groq API**: Secondary LLM service using moonshotai/kimi-k2-instruct model for strategic consulting insights
